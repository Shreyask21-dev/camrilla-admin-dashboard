...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: '/UserManagement', icon: 'ri-wechat-line', label: 'User Management' },
    { href: '/Subscriptions', icon: 'ri-mail-open-line', label: 'Subscriptions' },
    { href: '/PlanManagement', icon: 'ri-wechat-line', label: 'Plans Management' },
